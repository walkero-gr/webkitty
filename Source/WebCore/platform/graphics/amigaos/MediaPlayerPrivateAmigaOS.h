...
class MediaPlayerPrivateAmigaOS : public MediaPlayerPrivateInterface, public Acinerella::AcinerellaClient, public CanMakeWeakPtr<MediaPlayerPrivateAmigaOS, WeakPtrFactoryInitialization::Eager>
{
    WTF_MAKE_FAST_ALLOCATED;
public:
    MediaPlayerPrivateAmigaOS(MediaPlayer*);
    virtual ~MediaPlayerPrivateAmigaOS();
	...
	void accInitialized(MediaPlayerAmigaOSInfo info) override;
	void accUpdated(MediaPlayerAmigaOSInfo info) override;
	...
	const MediaPlayerAmigaOSStreamSettings &streamSettings() { return m_streamSettings; }
...
protected:
	...
	MediaPlayerAmigaOSStreamSettings m_streamSettings;
...
#if ENABLE(MEDIA_SOURCE)
	RefPtr<MediaSourcePrivateAmigaOS> m_mediaSourcePrivate;
#endif
