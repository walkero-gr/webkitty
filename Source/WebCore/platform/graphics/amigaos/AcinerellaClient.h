...
{
public:
	virtual const MediaPlayerAmigaOSStreamSettings& streamSettings() = 0;
	virtual void accInitialized(MediaPlayerAmigaOSInfo info) = 0;
	virtual void accUpdated(MediaPlayerAmigaOSInfo info) = 0;
